...
import CurrentTraineeSchema from '../../../schemas/CurrentTraineeSchema.js'
...
const EditTraineeProfileForm = ({setOpen }) => {
  ...
  const { control, handleSubmit, formState: { errors }, reset, setError} = useForm({
    resolver: zodResolver(CurrentTraineeSchema),
    defaultValues:{
...
export default EditTraineeProfileForm