...
import EditTrainerSecurityForm from "./forms/EditTrainerSecurityForm.jsx";
import EditTrainerProfileForm from "./forms/EditTrainerProfileForm.jsx";
  ...
  return (
    <div className="w-full flex-1">
      ...
      <Modal isOpen={isEditProfileOpen} setOpen={setEditProfileOpen} title={"Edit your profile"}>
        <EditTrainerProfileForm setOpen={setEditProfileOpen} />
      </Modal>
      <Modal isOpen={isEditSecurityOpen} setOpen={setEditSecurityOpen} title={"Change your password"}>
        <EditTrainerSecurityForm setOpen={setEditSecurityOpen} />
      </Modal>
      ...
      <div className="w-full h-16 flex items-center justify-between p-6 border-b border-stone-200">
        ...
        <div className="flex items-center justify-end w-80">
          ...
          >
            ...
            {open && (
              <div className="p-4 flex flex-col items-center gap-3 z-[90] absolute top-12 right-0 w-40 ring-1 ring-gray-200 bg-white rounded-md">
                <button
                ...
                <button
                  className="h- w-full flex items-center justify-start gap-2 font-medium text-base text-rose-500 "
