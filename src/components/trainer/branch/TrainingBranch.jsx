...
import EditTrainingForm from "../forms/EditTrainingForm.jsx";
...
const TrainingBranch = ({ setActiveBranch, setData }) => {
  ...
  const handleOpenDeleteModal = (e, training) => {
    e.stopPropagation();
    setSelectedTraining(training);
    setDeleteOpen(true);
  }
  ...
  return (
    <div className="w-full h-full flex flex-col overflow-hidden">
      <div
        ...
        style={{ gridTemplateColumns: "auto 20% 15% 15% 10% 15% 5%" }}
      >
            ...
            >
              ...
              <div className="px-8 h-full flex items-center justify-center  border-stone-200">
                {training.status === "on hold" ? (
                  <button 
                    className="text-xs uppercase px-4 py-2 rounded-md text-amber-500 w-16"
