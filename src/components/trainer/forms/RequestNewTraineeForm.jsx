...
import RequestTraineeSchema from '../../../schemas/RequestTraineeSchema.js'
import Button from '../../ui/Button'
import ImageInput from '../../ui/ImageInput'
import axios from 'axios'
import useAccountStore from '../../../stores/trainer/AccountStore.js'

const RequestNewTraineeForm = ({setOpen}) => {
  ...
  const { control, handleSubmit, formState: { errors }, reset, setError } = useForm({
    resolver: zodResolver(RequestTraineeSchema),
    defaultValues: {
      trainerId: user._id,
    }
  });
...
export default RequestNewTraineeForm
