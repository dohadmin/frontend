...
import SelectTrainerInput from "../ui/SelectTrainerInput";
import SelectTraineeInput from "../ui/SelectTraineeInput";
...
import SelectCertificateInput from "../ui/SelectCertificateInput.jsx";
...
const EditNewTrainingForm = ({ selectedTraining, setOpen }) => {
  ...
  const onSubmit = async (data) => {
    ...
    setLoading(true)
    try {
      const res = await axios.put('https://server-np0x.onrender.com/training/release-training', data)
