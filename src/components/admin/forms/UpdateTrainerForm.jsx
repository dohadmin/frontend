...
const UpdateTrainerForm = ({setOpen, trainer, setData}) => {
  ...
  const { control, handleSubmit, formState: { errors }, reset, setError} = useForm({
    ...
    defaultValues:{
      ...
      middleInitial: trainer.middleInitial,
      lastName: trainer.lastName,
      dateOfBirth: trainer.dateOfBirth,
      civilStatus: trainer.civilStatus,
      gender: trainer.gender,
      street: trainer.street,
      municipality: trainer.municipality,
      city: trainer.city,
  ...
  return (
    <form className="p-6 flex flex-col items-start gap-4 " onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-lg font-medium text-gray-700">Trainer Details</h1>
      </div>
      <div className=" flex flex-col gap-2 w-full">        
