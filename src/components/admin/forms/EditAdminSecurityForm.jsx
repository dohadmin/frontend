...
const EditAdminSecurityForm = ({ setOpen }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const res = await axios.put('http://localhost:8080/account/update-admin-security', newData)
...
export default EditAdminSecurityForm